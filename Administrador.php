...
if (isset($_POST['usuario'])) {
  ...
  $MM_redirectLoginSuccess = "ante_gineco_andrologico.php";
  $MM_redirectLoginFailed = "index.php";
  $MM_redirecttoReferrer = true;
  mysql_select_db($database_Historial, $Historial);
  
  $LoginRS__query=sprintf("SELECT Cedula_prof, Contraseña FROM administrativo WHERE Cedula_prof='%s' AND Contraseña='%s'",
