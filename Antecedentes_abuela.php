...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO abuela_materna (Id_registro, Id_paciente, Nombre, Edad, Tabaquimo, Alcoholismo, Enfermedades, Alergias) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['Id_registro'], "int"),
                       GetSQLValueString($_POST['Id_paciente'], "int"),
                       GetSQLValueString($_POST['Nombre'], "text"),
                       GetSQLValueString($_POST['Edad'], "int"),
                       GetSQLValueString($_POST['Tabaquimo'], "text"),
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap align="right">Tabaquimo:</td>
      <td><input type="text" name="Tabaquimo" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
